...
ggplot(toplo3, aes(x = tn_load, y = avechl)) +
  ...
  labs(
    title = 'Average Predicted Chlorophyll-a vs. Nitrogen Load in Old Tampa Bay Under Load Reduction Scenarios',
    y = 'µg/L',
    x = 'Average TN Load (tons/yr)',
  )
```